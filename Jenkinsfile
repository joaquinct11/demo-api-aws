...
//        stage('Deploy to EC2') {
//            steps {
//                sshagent(['ec2-key']) { // <- ID de la credencial en Jenkins
//                    sh '''
...
//                        ssh -o StrictHostKeyChecking=no ubuntu@18.232.181.253 "pkill -f app.jar || true && nohup java -jar /home/ubuntu/app/app.jar > /home/ubuntu/app/app.log 2>&1 &"
//                    '''
//                }
//            }
//        }
